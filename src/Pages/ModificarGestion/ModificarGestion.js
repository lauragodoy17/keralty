...
import ModificarDatosPersonalesGestion from '../ModificarDatosPersonalesGestion/ModificarDatosPersonalesGestion';
...
function ModificarGestion() {
  ...
  const buttons = {
    'Datos personales y únicos': <ModificarDatosPersonalesGestion />,
  };
