...
import DatosPersonalesGestion from '../DatosPersonalesGestion/DatosPersonalesGestion';
...
function IngresoGestion() {
    ...
    axios.defaults.withCredentials=true; 
      ...
      const buttons={
          'Datos personales y únicos': <DatosPersonalesGestion/>,
      }
