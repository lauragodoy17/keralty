...
import DatosPersonalesContratador from '../DatosPersonalesContratador/DatosPersonalesContratador';


function IngresoContratador() {
    ...
    axios.defaults.withCredentials=true; 
      ...
      const buttons={
          'Datos personales y únicos': <DatosPersonalesContratador/>,
      }
...
export default IngresoContratador
