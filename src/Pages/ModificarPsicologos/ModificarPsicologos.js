...
import ModificarDatosPersonalesPsicologos from '../ModificarDatosPersonalesPsicologos/ModificarDatosPersonalesPsicologos';

function ModificarPsicologos() {
  ...
  const buttons = {
    'Datos personales y únicos': <ModificarDatosPersonalesPsicologos />,
  };
...
export default ModificarPsicologos;
