...
function BusquedaDatosPersonal() {
  ...
  const calculateCompletionPercentage = (user) => {
    const fields = [
      user.fotocopiaDocumento,
      user.hojaVida,
      user.certificadosLaborales,
      user.fotocopiaTarjetaProfesional,
      user.diplomaActaBachiller,
      user.diplomaActaProfesional,
      user.diplomaActaEspecializacion, 
      user.certificadoEstudios,
      user.certificadoEPS,
      user.fechaCertificadoEPS,
      user.certificadoFondoPensiones,
      user.fechaCertificadoFondoPensiones,
      user.certificadoFondoCesantias,
      user.fechaCertificadoFondoCesantias, 
      user.certificadoCuentaBancaria,
      user.fechaCertificadoCuentaBancaria,
      user.tarjetaSecretariaSalud,
  ...
  return (
    <div className='busqueda-propia-container'>
      <div className='Busqueda_Datos_Personal_BD'>
        <h1>BUSQUEDA PARA DATOS PERSONALES </h1>
